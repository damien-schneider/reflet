...
describe("admin_api_members", () => {
  test("listMembers should return org members", async () => {
    ...
    const members = await t.query(internal.admin_api_members.listMembers, {
      organizationId: orgId,
    });
  ...
  test("createInvitation should create a pending invitation", async () => {
    ...
    const invitations = await t.query(
      internal.admin_api_members.listInvitations,
      { organizationId: orgId }
    );
  ...
  test("createInvitation should reject duplicate pending invitation", async () => {
    ...
    await t.mutation(internal.admin_api_members.createInvitation, {
      organizationId: orgId,
    ...
    await expect(
      t.mutation(internal.admin_api_members.createInvitation, {
        organizationId: orgId,
        email: "dup@example.com",
        role: "admin",
      })
  ...
  test("cancelInvitation should delete pending invitation", async () => {
    ...
    await t.mutation(internal.admin_api_members.cancelInvitation, {
      organizationId: orgId,
      invitationId,
    });
  ...
  test("cancelInvitation should reject non-pending invitation", async () => {
    ...
    await expect(
      t.mutation(internal.admin_api_members.cancelInvitation, {
        organizationId: orgId,
        invitationId,
      })
