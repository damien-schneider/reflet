...
describe("admin_api_feedback - updateFeedback", () => {
  test("should update title and description", async () => {
    ...
    await t.mutation(internal.admin_api_feedback.updateFeedback, {
      organizationId: orgId,
      feedbackId,
      title: "Updated Title",
  ...
  test("should reject wrong org", async () => {
    ...
    await expect(
      t.mutation(internal.admin_api_feedback.updateFeedback, {
...
describe("admin_api_feedback - deleteFeedback / restoreFeedback", () => {
  test("should soft-delete with deletedAt timestamp", async () => {
    ...
    await t.mutation(internal.admin_api_feedback.deleteFeedback, {
      organizationId: orgId,
      feedbackId,
    });
  ...
  test("restore should clear deletedAt", async () => {
    ...
    await t.mutation(internal.admin_api_feedback.restoreFeedback, {
      organizationId: orgId,
      feedbackId,
    });
  ...
  test("restore should fail if not deleted", async () => {
    ...
    await expect(
      t.mutation(internal.admin_api_feedback.restoreFeedback, {
        organizationId: orgId,
        feedbackId,
      })
...
describe("admin_api_feedback - assignFeedback", () => {
  test("should assign a member", async () => {
    ...
    await t.mutation(internal.admin_api_feedback.assignFeedback, {
      organizationId: orgId,
      feedbackId,
      assigneeId: "user-123",
    });
  ...
  test("should reject non-member assignee", async () => {
    ...
    await expect(
      t.mutation(internal.admin_api_feedback.assignFeedback, {
        organizationId: orgId,
        feedbackId,
...
describe("admin_api_feedback - setFeedbackStatus", () => {
  test("should set built-in status", async () => {
    ...
    await t.mutation(internal.admin_api_feedback.setFeedbackStatus, {
      organizationId: orgId,
      feedbackId,
      status: "in_progress",
    });
  ...
  test("should reject status from wrong org", async () => {
    ...
    await expect(
      t.mutation(internal.admin_api_feedback.setFeedbackStatus, {
        organizationId: orgId,
        feedbackId,
...
describe("admin_api_feedback - updateFeedbackTags", () => {
  test("should add and remove tags", async () => {
    ...
    // Add both tags
    await t.mutation(internal.admin_api_feedback.updateFeedbackTags, {
      organizationId: orgId,
      feedbackId,
  ...
  test("should reject tag from wrong org", async () => {
    ...
    await expect(
      t.mutation(internal.admin_api_feedback.updateFeedbackTags, {
        organizationId: orgId,
        feedbackId,
...
describe("admin_api_feedback - updateFeedbackAnalysis", () => {
  test("should update priority, complexity, and timeEstimate", async () => {
    ...
    await t.mutation(internal.admin_api_feedback.updateFeedbackAnalysis, {
      organizationId: orgId,
      feedbackId,
      priority: "high",
      complexity: "moderate",
...
describe("admin_api_feedback - comment mutations", () => {
  test("updateComment should update body", async () => {
    ...
    await t.mutation(internal.admin_api_feedback.updateComment, {
      organizationId: orgId,
      commentId,
  ...
  test("updateComment should reject comment from other org", async () => {
    ...
    await expect(
      t.mutation(internal.admin_api_feedback.updateComment, {
        organizationId: otherOrgId,
        commentId,
        body: "Hacked",
      })
  ...
  test("deleteComment should remove comment, replies, and update count", async () => {
    ...
    await t.mutation(internal.admin_api_feedback.deleteComment, {
      organizationId: orgId,
      commentId,
    });
  ...
  test("markCommentOfficial should toggle isOfficial", async () => {
    ...
    await t.mutation(internal.admin_api_feedback.markCommentOfficial, {
      organizationId: orgId,
      commentId,
      isOfficial: true,
    });
