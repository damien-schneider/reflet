/**
 * Shared model constants for all autopilot role skills.
 *
 * Strict tier routing (Tran & Kiela 2026 + iternal.ai 2026 hierarchical
 * routing 97.7% accuracy at 61% cost):
 * - Producer role skills (PM, CTO, Growth, Sales, Support) -> FAST_MODELS only.
 * - ORCHESTRATOR + VALIDATOR roles (CEO, Validator) → QUALITY_MODELS only.
 *
 * Producer role skills handle bounded chain nodes. Decisions are bounded too —
...
/**
 * FAST tier - for all producer role skills (PM, CTO, Growth, Sales, Support).
 ...
 * Use for: cross-role coordination, scoring rubric application, terminal decisions.
 * Producer role skills must NOT use this tier.
 */
