/**
 * Product context loading — shared by all Growth role skill modules.
 */
...
export interface ProductContext {
  ...
  roleSkillContext: string;
}

export const MISSING_PRODUCT_DEF_MESSAGE =
  "Growth role skill skipped — no product profile found in the Knowledge Base. " +
