...
import { buildRoleSkillPrompt, GROWTH_SYSTEM_PROMPT } from "../prompts";
import {
  ...
  handler: async (ctx, args) => {
    ...
    try {
      ...
      const guardResult = await ctx.runQuery(
        ...
        { organizationId: orgId, role: "growth" }
      );
...
- Provide actionable findings that PM and Sales role skills can use
