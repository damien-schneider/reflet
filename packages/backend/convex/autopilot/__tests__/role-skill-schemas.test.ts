/**
 * Role-skill schema tests - Azure OpenAI compatibility.
 *
 ...
 *
 * These tests prevent regressions by verifying every role-skill schema's
...
// CTO role-skill schema
import { technicalSpecSchema } from "../role_skills/cto";

// Growth role-skill schemas
import {
  enrichedThreadSchema,
  growthContentSchema,
} from "../role_skills/growth/discovery";

// PM role-skill schema
import { pmAnalysisSchema } from "../role_skills/pm/analysis";

// Support role-skill schemas
import {
  shippedNotificationSchema,
  triageResultSchema,
} from "../role_skills/support";
...
describe("role-skill schemas - Azure compatibility", () => {
...
describe("role-skill schemas - required fields are validated", () => {
