...
/**
 * Get organization configuration for the public API (new flow)
 */
...
/**
 * List feedback by organization for public API (new flow)
 */
...
/**
 * List feedback for public API (legacy board-based)
 */
...
/**
 * Get single feedback item for public API (organization-based)
 */
...
/**
 * Get single feedback item for public API (legacy board-based)
 */
...
/**
 * Get roadmap data for public API (board-level, legacy)
 */
...
// ============================================
// ORGANIZATION-LEVEL MUTATIONS (New flow)
// ============================================

/**
 * Create feedback via public API (organization-level)
 */
...
/**
 * Vote on feedback via public API (organization-level)
 */
...
/**
 * List comments for feedback item (organization-level)
 */
...
/**
 * Add a comment to feedback via public API (organization-level)
 */
...
/**
 * Subscribe to feedback updates via public API (organization-level)
 */
...
/**
 * Unsubscribe from feedback updates via public API (organization-level)
 */
...
/**
 * Get roadmap data for public API (organization-level)
 */
...
/**
 * Get changelog/releases for public API (organization-level)
 */
