...
export function registerAdminManagementRoutes(http: Router): void {
  ...
  http.route({
    ...
    handler: adminGet(async (ctx, { organizationId }, url) => {
      const statusParam = url.searchParams.get("status") as
        ...
        | "all"
        | null;
      return await ctx.runQuery(internal.admin_api_milestones.listMilestones, {
        organizationId,
  ...
  http.route({
    ...
    handler: adminGet(async (ctx, { organizationId }, url) => {
      ...
      return await ctx.runQuery(internal.admin_api_milestones.getMilestone, {
        organizationId,
  ...
  http.route({
    ...
    handler: adminPost(async (ctx, { organizationId }, body) => {
      const timeHorizon = str(body.timeHorizon) as
        ...
        | undefined;
      return await ctx.runMutation(
        internal.admin_api_milestones.updateMilestone,
        {
          organizationId,
  ...
  http.route({
    ...
    method: "POST",
    handler: adminPost(async (ctx, { organizationId }, body) =>
      ctx.runMutation(internal.admin_api_milestones.completeMilestone, {
        organizationId,
        milestoneId: parseId<"milestones">(
          str(body.milestoneId),
          "milestoneId"
  ...
  http.route({
    ...
    method: "POST",
    handler: adminPost(async (ctx, { organizationId }, body) =>
      ctx.runMutation(internal.admin_api_milestones.deleteMilestone, {
        organizationId,
        milestoneId: parseId<"milestones">(
          str(body.milestoneId),
          "milestoneId"
  ...
  http.route({
    ...
    handler: adminPost(async (ctx, { organizationId }, body) => {
      ...
      return await ctx.runMutation(
        internal.admin_api_milestones.linkMilestoneFeedback,
        {
          organizationId,
          milestoneId: parseId<"milestones">(
            str(body.milestoneId),
  ...
  http.route({
    ...
    handler: adminGet(async (ctx, { organizationId }) =>
      ctx.runQuery(internal.admin_api_members.listMembers, {
        organizationId,
      })
    ),
  });
  ...
  http.route({
    ...
    method: "GET",
    handler: adminGet(async (ctx, { organizationId }) =>
      ctx.runQuery(internal.admin_api_members.listInvitations, {
        organizationId,
      })
    ),
  });
  ...
  http.route({
    ...
    handler: adminPost(async (ctx, { organizationId }, body) => {
      ...
      return await ctx.runMutation(
        internal.admin_api_members.createInvitation,
        {
          organizationId,
  ...
  http.route({
    ...
    method: "POST",
    handler: adminPost(async (ctx, { organizationId }, body) =>
      ctx.runMutation(internal.admin_api_members.cancelInvitation, {
        organizationId,
  ...
  http.route({
    ...
    method: "GET",
    handler: adminGet(async (ctx, { organizationId }) =>
      ctx.runQuery(internal.admin_api_organization.getOrganization, {
        organizationId,
      })
    ),
  });
  ...
  http.route({
    ...
    method: "POST",
    handler: adminPost(async (ctx, { organizationId }, body) =>
      ctx.runMutation(internal.admin_api_organization.updateOrganization, {
        organizationId,
        name: str(body.name),
        isPublic: bool(body.isPublic),
