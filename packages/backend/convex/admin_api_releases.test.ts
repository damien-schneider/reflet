...
describe("admin_api_releases", () => {
  test("createRelease should create a release", async () => {
    ...
    const result = await t.mutation(internal.admin_api_releases.createRelease, {
      organizationId: orgId,
  ...
  test("listReleases should paginate and sort by newest", async () => {
    ...
    await t.mutation(internal.admin_api_releases.createRelease, {
      organizationId: orgId,
      title: "First",
    });
    await t.mutation(internal.admin_api_releases.createRelease, {
    ...
    const result = await t.query(internal.admin_api_releases.listReleases, {
      organizationId: orgId,
    });
  ...
  test("listReleases should filter by status", async () => {
    ...
    const { id: pubId } = await t.mutation(
      internal.admin_api_releases.createRelease,
      { organizationId: orgId, title: "Published" }
    );

    await t.mutation(internal.admin_api_releases.publishRelease, {
      organizationId: orgId,
      releaseId: pubId,
    });

    const published = await t.query(internal.admin_api_releases.listReleases, {
      organizationId: orgId,
      status: "published",
    });
    ...
    const drafts = await t.query(internal.admin_api_releases.listReleases, {
      organizationId: orgId,
      status: "draft",
    });
  ...
  test("getRelease should return release with linked feedback", async () => {
    ...
    await t.mutation(internal.admin_api_releases.linkReleaseFeedback, {
      organizationId: orgId,
      releaseId,
      feedbackId,
      action: "link",
    ...
    const release = await t.query(internal.admin_api_releases.getRelease, {
      organizationId: orgId,
      releaseId,
    });
  ...
  test("getRelease should return null for wrong org", async () => {
    ...
    const result = await t.query(internal.admin_api_releases.getRelease, {
  ...
  test("updateRelease should update fields", async () => {
    ...
    await t.mutation(internal.admin_api_releases.updateRelease, {
      organizationId: orgId,
      releaseId,
      title: "New Title",
      version: "v2.0.0",
  ...
  test("publishRelease and unpublishRelease toggle publishedAt", async () => {
    ...
    await t.mutation(internal.admin_api_releases.unpublishRelease, {
      organizationId: orgId,
      releaseId,
    });
  ...
  test("deleteRelease should remove release and its feedback links", async () => {
    ...
    await t.mutation(internal.admin_api_releases.deleteRelease, {
      organizationId: orgId,
      releaseId,
    });
