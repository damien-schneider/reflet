...
- Screenshot capture runs on `@zumer/snapdom` 3; apps that also install snapdom directly need `^3.0.0`
- Base UI, React and the rest of the toolchain move to their latest releases
