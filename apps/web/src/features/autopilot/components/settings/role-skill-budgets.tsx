...
export function RoleSkillBudgets({
  storedValue,
  disabled,
  onSave,
}: {
    ...
    <Card>
      <CardContent className="space-y-3 pt-4">
        ...
        <p className="text-muted-foreground text-xs">
          Leave blank for no role-skill limit. Total daily cap still applies.
        </p>
      </CardContent>
    </Card>
  );
