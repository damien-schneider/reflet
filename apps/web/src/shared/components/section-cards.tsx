  ...
  return (
    <div className="grid grid-cols-1 gap-4 px-4 md:grid-cols-2 lg:grid-cols-4 lg:px-6">
      <Card>
        ...
        <CardContent>
          <div className="font-semibold text-2xl">$45,231.89</div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="font-semibold text-2xl">+2350</div>
          <p className="text-muted-foreground text-xs">
      ...
      <Card>
        ...
        <CardContent>
          <div className="font-semibold text-2xl">+12,234</div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="font-semibold text-2xl">+573</div>
