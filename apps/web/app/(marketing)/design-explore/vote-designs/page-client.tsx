      ...
      >
        ...
        <AnimatePresence mode="popLayout">
          <m.span
            ...
            className={cn(
              "relative z-10 font-semibold text-base tabular-nums",
  ...
  return (
    <div className="group relative flex overflow-hidden rounded-xl border border-border/50 bg-card transition-all hover:border-border hover:shadow-sm">
      ...
      <div className="relative flex w-10 shrink-0 flex-col items-center justify-center gap-1 border-border/30 border-r">
        ...
        <span
          className={cn(
            "relative z-10 font-semibold text-[11px] tabular-nums",
            voteType === "upvote" && "text-primary",
            voteType === "downvote" && "text-destructive",
            !voteType && "text-foreground"
          )}
...
function DesignCornerBadge() {
  ...
  return (
    <div className="relative">
      <FullCard>
        <div className="space-y-3 p-4 pr-20">
          <CardTitle />
          <CardTags />
          <CardMeta />
        </div>
      ...
      >
        ...
        <AnimatePresence mode="popLayout">
          <m.span
            animate={{ y: 0, opacity: 1 }}
            className={cn(
              "px-2 py-1.5 font-semibold text-xs tabular-nums",
              voteType === "upvote" && "text-primary",
              voteType === "downvote" && "text-destructive",
              !voteType && "text-foreground"
            )}
      ...
      <div className="flex items-start gap-2 p-3">
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="mt-1.5 flex flex-wrap items-center gap-1.5 text-[10px] text-muted-foreground">
            <span
              className={cn(
                "rounded bg-muted/60 px-1.5 py-0.5 font-semibold tabular-nums",
                net > 0 && "text-primary",
        ...
        <div className="flex -gap-x-2">
          {MOCK_VOTERS.slice(0, displayCount).map((initials, i) => (
            <m.div
              ...
              className="flex size-6 items-center justify-center rounded-full border-2 border-card bg-muted font-semibold text-[8px] text-muted-foreground"
          ...
          {voteType === "upvote" && (
            <m.div
              animate={{ scale: 1, opacity: 1 }}
              className="flex size-6 items-center justify-center rounded-full border-2 border-primary/30 bg-primary/10 font-semibold text-[8px] text-primary"
              initial={{ scale: 0.95, opacity: 0 }}
              transition={{ type: "spring", stiffness: 400, damping: 15 }}
            >
              <UserIcon className="size-3" weight="fill" />
            </m.div>
          )}
        </div>
        {/* Social text */}
  ...
  return (
    <div className="group flex gap-3">
      ...
      >
        ...
        <AnimatedCount className="font-semibold text-base" value={upvotes} />
      </m.button>
      ...
      <AnimatePresence mode="sync">
        {voteType && (
          <m.div
            ...
            className="absolute z-0 size-32 rounded-full"
            exit={{ opacity: 0 }}
...
function DesignCornerPercentage() {
  ...
  return (
    <div className="relative">
      <FullCard>
        <div className="space-y-3 p-4 pr-24">
          <CardTitle />
          <CardTags />
          <CardMeta />
        </div>
      ...
      >
        ...
        <span
          className={cn("font-semibold text-sm tabular-nums", percentColor)}
        >
          {upPercent}%
        </span>
          ...
          <AnimatePresence>
            {voteType && (
              <m.div
                ...
                className={cn(
                  "absolute top-1/2 left-1/2 size-10 -translate-x-1/2 -translate-y-1/2 rounded-full blur-xl",
  ...
  return (
    <div className="flex overflow-hidden rounded-2xl border border-border/30">
      ...
      >
        ...
        <AnimatedCount
          className={cn(
            "relative z-10 font-semibold text-2xl tabular-nums",
            voteType === "upvote" && "text-primary",
            voteType === "downvote" && "text-destructive",
            !voteType && "text-foreground"
          )}
