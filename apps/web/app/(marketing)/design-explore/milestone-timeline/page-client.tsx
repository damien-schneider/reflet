        ...
        {MOCK_MILESTONES.map((m) => {
          ...
          return (
            <div className="relative" key={m.id}>
              <div
                className="absolute top-3 -left-5 size-2.5 rounded-full border-2 border-background"
                  ...
                  {isActive && (
                    ...
                    >
                      <div className="mt-2 border-t pt-2">
                        ...
                        <div className="mt-1.5 gap-y-0.5">
  ...
  return (
    <div className="space-y-4">
      <div className="grid grid-cols-4 gap-3">
        ...
        <div className="rounded-lg border bg-card p-3 text-center">
          <p className="font-semibold text-2xl text-emerald-500 tabular-nums">
  ...
  return (
    <div className="space-y-6 px-4">
      <div className="border-foreground border-b-2 pb-2">
        <h3 className="font-semibold font-serif text-lg italic tracking-tight">
          Product Roadmap
        </h3>
        <p className="text-[11px] text-muted-foreground">
              ...
              <div className="relative z-10 flex w-full items-center gap-3">
                ...
                {m.targetDate && (
                  <span className="flex items-center gap-1 text-[10px] text-muted-foreground">
                    <ClockIcon className="size-3" weight="regular" />
                    {m.targetDate}
                  </span>
                )}
                <span className="rounded bg-muted px-1.5 py-0.5 text-[10px]">
        ...
        return (
          <div className="relative mb-4 last:mb-0" key={m.id}>
            ...
            <div className="absolute top-0 -left-6 flex flex-col items-center">
              <div
                className="flex size-8 items-center justify-center rounded-full border-2 border-background text-[10px] shadow-sm"
                style={{ backgroundColor: m.colorHex }}
              >
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  ...
                  {m.targetDate && (
                    <span className="flex items-center gap-1 text-[10px] text-muted-foreground">
                      <CalendarBlankIcon className="size-3" weight="regular" />
                      {m.targetDate}
                    </span>
                  )}
                </div>
...
function DesignEditorialAccordion() {
  ...
  return (
    <div className="gap-y-0 divide-y divide-border/40">
      {MOCK_MILESTONES.slice(0, 5).map((m) => {
        const isOpen = openId === m.id;
        return (
          <motion.div
