...
export function InsightsTab({
  ...
  const insights = useQuery(api.autopilot.intelligence.insights.list, {
    organizationId,
  ...
  const dismissInsight = useMutation(
    api.autopilot.intelligence.insights.dismiss
  );
  const convertToFeedback = useMutation(
    api.autopilot.intelligence.insights.convertToFeedback
  );
